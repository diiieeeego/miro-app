    ...
    <View style={styles.overlay}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerDesc}>Doživljaji na zadarskim otocima</Text>
        </View>
        ...
        <BlurView intensity={35} tint="dark" style={styles.placeholderCard}>
          ...
          <Text style={styles.placeholderSub}>
            Ovdje će biti prikazani otočni doživljaji — izleti brodom, skrivene plaže, Kornati i više.
          </Text>
        </BlurView>
      </ScrollView>
      <BottomTabBar />
