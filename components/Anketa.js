...
export default function AnketaScreen({ embedded = false } = {}) {
  ...
  if (loading) {
    return embedded ? (
      <View style={[styles.embeddedWrap, styles.centered]}>
              ...
              >
                ...
                >
                  <View style={styles.optionContent}>
                    ...
                    {voted && <Text style={styles.percentageText}>{pct.toFixed(0)}%</Text>}
                  </View>
                  {voted && (
                    <View style={styles.progressBarBg}>
                      <View
                        style={[
                          ...
                          {
                            width: `${pct}%`,
                            backgroundColor: isSelected ? "#f59e0b" : "rgba(255,255,255,0.3)",
                          },
                        ]}
                      />
                    </View>
